...
const SpeakersListDetails = () => {
  ...
  `)
    ...
    return (
        <section className="inner-page-wrapper speakers-details">
            <h2 className="text-center">Our Speakers</h2>
            <div className="block">
                <div className="grid">
                    {data.allContentfulSpeaker.edges.map((edge) => { 
                        return (
                            <div className="speaker col-6_sm-12" key={edge.node.speakerId}>
                                <div className="img">
...
export default SpeakersListDetails